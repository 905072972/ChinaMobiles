								...
								<TBODY>
									<TR>
										...
										<TD width=165 height="29" bgColor=#7691c7>
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<A class=nav href="newOperator.htm">新增操作员</A>
										</TD>
									</TR>
									<!--TR>
          ...
          <TD width=165 height="29" bgColor=#7691c7>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<A 
            ...
            href="modifyOperator.htm">修改操作员</A></TD>
									...
									<TR>
										...
										<TD width=165 height="29" bgColor=#7691c7>
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<A class=nav href="resource.htm">资源管理</A>
										</TD>
									</TR>
									<TR>
										<TD bgColor=#ffffff colSpan=2>
					...
					<TR vAlign=top>
						<TD height="600" bgColor=#f1f3f9>
							<form method="POST" action="--WEBBOT-SELF--">
								<p>
									登录ID：
									<input type="text" name="T1" size="20" value="A00000001">
								</p>
								<p>
									姓 名：
									<input type="text" name="T2" size="20" value="张三">
								</p>
								<p>
									密码：
