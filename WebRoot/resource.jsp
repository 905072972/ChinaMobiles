					...
					<TR>
						<TD width=173>
							<A href="http://www.chinamobile.com/index.asp"><IMG height=74
									src="images/logo.gif" width=173 border=0>
							</A>
						</TD>
							...
							<TABLE width="100%" border=0 cellPadding=0 cellSpacing=0>
								<TBODY>
									...
									<TR>
										...
										<TD>
											<img src="images/pic05.gif" width="115" height="55">
										</TD>
									</TR>
								</TBODY>
							</TABLE>
          ...
          <TD width=165 height="29" bgColor=#7691c7>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<A 
            ...
            href="modifyOperator.htm">修改操作员</A></TD>
									...
									<TR>
										...
										<TD width=165 height="29" bgColor=#7691c7>
											&nbsp;&nbsp;&nbsp;
											<A class=nav href="Charge.htm">配置业务费用</A>
										</TD>
									</TR>
									<TR>
										<TD bgColor=#ffffff colSpan=2>
          ...
          <TD width=165 height="29" bgColor=#7691c7>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<A 
            ...
            href="#"></A></TD-->
									...
									<TR>
										...
										<TD width=165 height="29" bgColor=#7691c7>
											&nbsp;&nbsp;&nbsp;
											<A class=nav href="newCustomer.htm">开户</A>
										</TD>
									</TR>
									<TR>
										<TD bgColor=#ffffff colSpan=2>
          ...
          <TD width=165 height="29" bgColor=#7691c7>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<A 
            ...
            href="newAccount.htm">录入账户信息</A></TD>
									...
									<TR>
										...
										<TD width=165 height="29" bgColor=#7691c7>
											&nbsp;&nbsp;&nbsp;
											<A class=nav href="Logout.htm">退出</A>
										</TD>
									</TR>
									<TR>
										<TD bgColor=#ffffff colSpan=2>
					...
					<TR vAlign=top>
						<TD height="600" bgColor=#f1f3f9>
							...
							<form method="POST" action="tmobileServlet.do">
								<p>
									号码类型：
									<input type="Radio" name="MType" value="SIM" checked>
									SIM &nbsp;&nbsp;
									<input type="Radio" name="R1" name="MType" value="UIM">
									UIM
								</p>
								<p>
									指定号段：从
									<input type="text" name="T1" size="20" value="13910000000">
									到
									<input type="text" name="T2" size="20" value="13912345678">							
									<input type="submit" value="提交" id="tijiao"  name="B1">
									<input type="reset" value="全部重写" name="B2">
									<input type="text" name ="lingpai"value="${kouling}">
								</p>
							</form>
							<hr>
						</TD>
