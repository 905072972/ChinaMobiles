							...
							<TABLE cellSpacing=0 cellPadding=0 width=173 border=0>
								<TBODY>
									...
									<TR>
										...
										<TD width=165 height="29" bgColor=#7691c7>
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<A class=nav href="modifyOperator.jsp">修改操作员</A>
										</TD>
									</TR>
									<TR>
										<TD bgColor=#ffffff colSpan=2>
									...
									<TR>
										...
										<TD width=165 height="29" bgColor=#7691c7>
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<A class=nav href="lingpai.do">资源管理</A>
										</TD>
									</TR>
									<TR>
										<TD bgColor=#ffffff colSpan=2>
									...
									<TR>
										...
										<TD width=165 height="29" bgColor=#7691c7>
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<A class=nav href="newUser.jsp">录入用户信息</A>
										</TD>
									</TR>
									<TR>
										<TD bgColor=#ffffff colSpan=2>
									...
									<TR>
										...
										<TD width=165 height="29" bgColor=#7691c7>
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<A class=nav href="newAccount.jsp">录入账户信息</A>
										</TD>
									</TR>
